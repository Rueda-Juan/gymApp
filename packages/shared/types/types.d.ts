export type MuscleGroup = 'chest' | 'upper-chest' | 'mid-chest' | 'lower-chest' | 'back' | 'lats' | 'upper-back' | 'mid-back' | 'lower-back' | 'shoulders' | 'front-delts' | 'side-delts' | 'rear-delts' | 'biceps' | 'triceps' | 'forearms' | 'legs' | 'quads' | 'hamstrings' | 'glutes' | 'calves' | 'abs' | 'core' | 'traps';
...
export type LoadType = 'fixed' | 'bodyweight' | 'variable';
