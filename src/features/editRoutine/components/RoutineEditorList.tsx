...
import { RoutineExerciseRow } from '@/entities/routine';
    ...
    return (
      <ScaleDecorator>
        <RoutineExerciseRow
          ...
          onViewDetails={onViewDetails ? () => onViewDetails(item.id) : undefined}
        />
      </ScaleDecorator>
    );
  }, [exercises, onRemove, onUpdate, onLinkNext, onUnlink, onViewDetails]);

  return (
    <DraggableFlatList
      testID="routine-editor-list"
      data={exercises}
