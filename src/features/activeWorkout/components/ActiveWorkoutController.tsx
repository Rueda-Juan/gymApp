...
export function ActiveWorkoutController() {
        ...
        { 
          ...
          onPress: async () => {
            try {
              ...
              // 1. Guardar todos los sets en la BD local
              await recordAllSets(workoutId, exercises);
              ...
              Alert.alert('Error', 'No se pudo guardar el entrenamiento en la base de datos.');
            }
          } 
        },
      ]
  ...
  return (
    <>
      <YStack flex={1} testID="workout-screen">
        <WorkoutHeader
        ...
        <YStack flex={1}>
          {currentExercise && (
            <ActiveWorkoutExerciseDetail
              ...
              onRemoveSet={(exId, _setId) => actions.handleUndoSetDeletion(exId)}
