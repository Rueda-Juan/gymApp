...
import { AppButton, AppText, AppIcon } from '@/shared/ui';
import { FONT_SCALE } from '@/shared/ui/theme/tamagui.config';
import { motion } from '@/shared/ui/theme/motion';
import { useBottomBarGestureAndAnimation } from '@/shared/ui/hooks/useBottomBarGestureAndAnimation';
import { triggerLightHaptic, triggerSelectionHaptic } from '@/shared/lib/haptics';
import { elevation } from '@/shared/ui/theme/elevation';
...
interface ActiveWorkoutBottomBarProps {
  ...
  insetsBottom: number;
  hourglassAnimatedStyle: AnimatedStyle<ViewStyle>;
  onPrev: () => void;
  onOpenNote: () => void;
    ...
    >
      ...
      <XStack alignItems="center" gap="$sm">
        ...
        <AppButton
          ...
          testID={isLast ? 'finish-workout-button' : 'next-exercise-button'}
