...
import { WorkoutWithExercises } from '@kernel';
...
export function LastWorkoutCard({ lastWorkout, onViewAll, onViewLast }: Props) {
            ...
            <YStack gap="$xs">
              <XStack alignItems="center" gap="$xs">
                ...
                <AppText variant="bodySm" color="textSecondary">
                  {Math.floor((lastWorkout.durationSeconds || 0) / 60)}
                </AppText>
              ...
              <XStack alignItems="center" gap="$xs">
                ...
                <AppText variant="bodySm" color="textSecondary">
                  {lastWorkout.workoutExercises?.length || 0}
                </AppText>
