...
import RoutinesPage from '../index';
...
jest.mock('@/entities/routine', () => ({
  useRoutineDb: jest.fn(() => mockRoutineService),
...
jest.mock('@/entities/workout', () => ({
  useWorkoutDb: jest.fn(() => mockWorkoutService),
  useActiveWorkout: jest.fn(() => ({ activeWorkout: null })),
}));
