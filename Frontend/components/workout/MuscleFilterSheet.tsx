            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              <YStack gap="$md">
                ...
                {HIERARCHICAL_MUSCLES.map((hm) => {
                  ...
                  const isAnySubActive = hasSubs && hm.subdivisions!.includes(selectedMuscle as any);
                  ...
                  return (
                    <Collapsible 
                      key={hm.category} 
                      title={`${MUSCLE_LABELS[hm.category]}${isAnySubActive || isMainActive ? ' •' : ''}`}
