...
export default function RestTimerScreen() {
  ...
  const m = useMotion();
  const isActive = useRestTimer((s: any) => s.isActive);
  const durationSeconds = useRestTimer((s: any) => s.durationSeconds);
  const getRemainingSeconds = useRestTimer((s: any) => s.getRemainingSeconds);
  const stopTimer = useRestTimer((s: any) => s.stopTimer);
  const adjustTimer = useRestTimer((s: any) => s.adjustTimer);
  const startTimer = useRestTimer((s: any) => s.startTimer);
