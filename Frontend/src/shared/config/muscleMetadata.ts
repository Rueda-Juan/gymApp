...
export const MUSCLE_METADATA: Record<MuscleKey, MuscleMetadata> = {
  ...
  biceps: {
    key: 'biceps', label: 'BÃƒÆ’Ã‚Â­ceps', svgId: 'biceps',
  },
  triceps: {
    key: 'triceps', label: 'TrÃƒÆ’Ã‚Â­ceps', svgId: 'triceps',
  },
  forearms: {
    key: 'forearms', label: 'Antebrazos', svgId: 'forearms',
  },
  quads: {
    key: 'quads', label: 'Cuadriceps', svgId: 'quads',
  },
  hamstrings: {
    key: 'hamstrings', label: 'Isquiotibiales', svgId: 'hamstrings',
  },
  glutes: {
    key: 'glutes', label: 'GlÃƒÆ’Ã‚Âºteos', svgId: 'glutes',
  },
  calves: {
