...
const MUSCLE_ICON_MAP: Partial<Record<MuscleKey, string>> = {
  ...
  "mid-back": "human-handsup",
  "lower-back": "human-handsup",
  "front-delts": "human-handsup",
  "side-delts": "human-handsup",
  "rear-delts": "human-handsup",
};
...
export const HIERARCHICAL_MUSCLES: {
  category: MuscleKey;
  subdivisions?: MuscleKey[];
}[] = [
  {
    category: "chest",
    subdivisions: ["upper-chest", "mid-chest", "lower-chest"],
  },
  {
    category: "back",
    subdivisions: ["lats", "upper-back", "mid-back", "lower-back", "traps"],
  },
  {
    category: "shoulders",
    subdivisions: ["front-delts", "side-delts", "rear-delts"],
  },
  { category: "arms", subdivisions: ["biceps", "triceps", "forearms"] },
  {
    category: "legs",
    subdivisions: ["quads", "hamstrings", "glutes", "calves", "adductors"],
  },
