...
import { useHomeData } from '@/features/dashboardSummary/model/useHomeData';
...
jest.mock('@/features/dashboardSummary/model/useHomeData', () => ({
  useHomeData: jest.fn(),
}));
