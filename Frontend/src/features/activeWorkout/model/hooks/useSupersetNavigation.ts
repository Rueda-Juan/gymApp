...
/**
 * useSupersetNavigation ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Maneja la navegaciÃƒÆ’Ã‚Â³n inteligente en supersets
 *
 * Responsabilidades:
 * - Detectar si un ejercicio pertenece a un superset
 * - Calcular el siguiente ejercicio (respetando orden de superset)
 * - Determinar si se completÃƒÆ’Ã‚Â³ el superset (todos los ejercicios con sets completos)
...
export function useSupersetNavigation() {
  ...
  /**
   * Obtiene el ÃƒÆ’Ã‚Â­ndice del prÃƒÆ’Ã‚Â³ximo ejercicio en el orden de superset,
  ...
  /**
   * Calcula los ÃƒÆ’Ã‚Â­ndices de los ejercicios que pertenecen al superset actual.
   */
