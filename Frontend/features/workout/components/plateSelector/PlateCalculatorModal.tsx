...
import { WeightEngine, WeightEngineResult } from '@/domain/weight/weightEngine';
          ...
          <YStack padding="$xl" gap="$lg">
            ...
            <YStack gap="$sm">
              ...
              <XStack justifyContent="space-between">
                ...
                <AppText variant="bodyMd" fontWeight="700" tabularNums>{result?.total ?? 0} kg</AppText>
              </XStack>
              {remainder > 0 && (
